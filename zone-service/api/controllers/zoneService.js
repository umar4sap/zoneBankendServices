...
function postzone(req, res) {
    ...
    var check = validator.isObject()
        ...
        .withRequired('openDays', validator.isAnyObject({ message: "openDays is required" }))
        .withRequired('zoneCurrentFacilities', validator.isAnyObject({ message: "zoneCurrentFacilities is required" }))
        //.withRequired('zoneCurrentDiscounts', validator.isAnyObject({ message: "zoneCurrentDiscounts is required" }))
        .withRequired('zoneFor', validator.isString({ message: "zoneFor is required" }))
